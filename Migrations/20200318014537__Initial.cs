    ...
    public partial class _Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FanStoryID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StoryText = table.Column<string>(maxLength: 2000, nullable: false),
                    Name = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FanStories", x => x.FanStoryID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RotationalPeriod = table.Column<int>(nullable: true),
                    OrbitalPeriod = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvgHeight = table.Column<int>(nullable: true),
                    Language = table.Column<string>(nullable: true),
                    AvgLifeSpan = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Commenter = table.Column<string>(maxLength: 50, nullable: false),
                    CommentText = table.Column<string>(maxLength: 2000, nullable: false),
                    FanStoryID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => x.CommentID);
                    table.ForeignKey(
                        name: "FK_Comments_FanStories_FanStoryID",
                        column: x => x.FanStoryID,
                        principalTable: "FanStories",
                        principalColumn: "FanStoryID",
                        onDelete: ReferentialAction.Restrict);
                });
